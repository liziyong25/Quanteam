...
本轮宿主终端实际命令：
1. `PYTHONPATH=src pytest -q tests/test_qa_fetch_registry.py tests/test_qa_fetch_resolver.py tests/test_qa_fetch_runtime.py tests/test_qa_fetch_probe.py tests/test_qa_fetch_exports.py tests/test_qa_fetch_registry_json.py tests/test_qa_fetch_registry_phase27.py tests/test_qa_fetch_agent_integration.py`
2. `python3 scripts/generate_qa_fetch_registry_json.py --check`
3. `python3 scripts/check_docs_tree.py`
