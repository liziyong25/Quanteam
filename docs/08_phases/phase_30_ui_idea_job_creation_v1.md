...
- `docs/08_phases/phase_30_ui_idea_job_creation_v1.md`
...
- This phase log file (`docs/08_phases/phase_30_ui_idea_job_creation_v1.md`)
- SSOT status update (`docs/12_workflows/agents_ui_ssot_v1.yaml`)
