...
- `docs/08_phases/00_skeleton/phase_60_*.md`
...
- Subagent 禁止修改 `docs/12_workflows/skeleton_ssot_v1.yaml`；仅主控在全部验收通过后回写 `G40.status_now=implemented`。
...
- Notes:
  ...
  - Evidence rendering is sourced from:
    ...
    - `docs/12_workflows/skeleton_ssot_v1.yaml` entries `goal_checklist(G40)` / `phase_dispatch_plan_v2` / `g40_object_model_ui_scope`
