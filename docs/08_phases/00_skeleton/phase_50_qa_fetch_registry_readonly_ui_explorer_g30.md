...
- `docs/08_phases/00_skeleton/phase_50_qa_fetch_registry_readonly_ui_explorer_g30.md`
...
- Subagent 禁止修改 `docs/12_workflows/skeleton_ssot_v1.yaml`；仅主控在全部验收通过后回写 `G30.status_now=implemented`。
